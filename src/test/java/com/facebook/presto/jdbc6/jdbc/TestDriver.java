 ...
 */
package com.facebook.presto.jdbc6.jdbc;

import com.facebook.presto.jdbc6.utils.Assertions;
import com.facebook.presto.jdbc6.utils.Java6TestPrestoServer;
...
public class TestDriver
{
    ...
    public void setup()
            throws Exception
    {
        server = new Java6TestPrestoServer(
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Assert.assertEquals(rs.getObject(8), new PrestoIntervalYearMonth(123, 11));
                    assertEquals(rs.getObject("h"), new PrestoIntervalYearMonth(123, 11));
                    Assert.assertEquals(rs.getObject(9), new PrestoIntervalDayTime(11, 22, 33, 44, 555));
            ...
            throws Exception
    {
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", null, null);
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", "tables", null);
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", "tables", new String[] {"BASE TABLE"});
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(null, "information_schema", null, null);
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(null, null, "tables", null);
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(null, null, null, new String[] {"BASE TABLE"});
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "inf%", "tables", null);
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", "tab%", null);
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables("unknown", "information_schema", "tables", new String[] {"BASE TABLE"});
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "unknown", "tables", new String[] {"BASE TABLE"});
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", "unknown", new String[] {"BASE TABLE"});
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", "tables", new String[] {"unknown"});
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", "tables", new String[] {"unknown", "BASE TABLE"});
            try {
                assertTableMetadata(rs);
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getTables(TEST_CATALOG, "information_schema", "tables", new String[] {});
            try {
                assertTableMetadata(rs);
            ...
            throws Exception
    {
        Connection connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getColumns(null, null, "tables", "column_name");
            try {
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getColumns(TEST_CATALOG, null, "tables", "column_name");
            try {
                assertColumnMetadata(rs);
            }
            finally {
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getColumns(null, "information_schema", "tables", "column_name");
            try {
                assertColumnMetadata(rs);
            }
            finally {
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getColumns(TEST_CATALOG, "information_schema", "tables", "column_name");
            try {
                assertColumnMetadata(rs);
            }
            finally {
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getColumns(TEST_CATALOG, "inf%", "tables", "column_name");
            try {
                assertColumnMetadata(rs);
            }
            finally {
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getColumns(TEST_CATALOG, "information_schema", "tab%", "column_name");
            try {
                assertColumnMetadata(rs);
            }
            finally {
        ...
        connection = createConnection();
        try {
            ResultSet rs = connection.getMetaData().getColumns(TEST_CATALOG, "information_schema", "tables", "col%");
            try {
                assertColumnMetadata(rs);
            }
            finally {
    ...
    */
    ...
    public void testConnectionWithCatalog()
            throws Exception
    {
        Connection connection = createConnection(TEST_CATALOG);
        try {
            Statement statement = connection.createStatement();
            try {
                ResultSet rs = statement.executeQuery("" +
    ...
    public void testUserIsRequired()
            throws Exception
    {
        Connection ignored = DriverManager.getConnection("jdbc:presto://test.invalid/");
        try {
            Assertions.fail("expected exception");
        }
        finally {
            ...
            throws Exception
    {
        ...
        Connection ignored = DriverManager.getConnection(url, "test", null);
        try {
            Assertions.fail("expected exception");
        }
        finally {
